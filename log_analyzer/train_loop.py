...
def eval_model(lm_evaluator: Evaluator, test_loader: Union[data_utils.LogDataLoader,data_utils.TieredLogDataLoader], store_eval_data=False, model_file_name="model.pt"):
