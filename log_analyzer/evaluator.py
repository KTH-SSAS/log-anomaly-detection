...
class Evaluator:
    ...
    def get_auc_score(self, fp_rate=None, tp_rate=None, normalised=False, nonskipped=False):
    ...
    def plot_roc_curve(self, title="ROC", normalised=False, nonskipped=False):
        ...
        if not self.data_is_prepared:
            self.prepare_evaluation_data()
        auc_score = self.get_auc_score(normalised=normalised, nonskipped=nonskipped)
