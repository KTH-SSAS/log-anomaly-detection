...
from log_analyzer.data.data_loader import IterableLogDataSet
import torch
...
def test_data_loader_char():
    ...
    dataset = IterableLogDataSet(filepath, bidirectional, skip_sos, jagged, sentence_length=input_length)
